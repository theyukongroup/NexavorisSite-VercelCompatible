...
export const authCopy: Record<Locale, AuthCopy> = {
  en: {
    ...
    weakPassword: 'Choose a stronger password with at least 10 characters.',
  ...
  'zh-cn': {
    ...
    weakPassword: '请设置更安全的密码，至少 10 个字符。',
  ...
  'zh-tw': {
    ...
    weakPassword: '請設定更安全的密碼，至少 10 個字元。',
  ...
  es: {
    ...
    weakPassword: 'Elija una contraseña más segura, de al menos 10 caracteres.',
